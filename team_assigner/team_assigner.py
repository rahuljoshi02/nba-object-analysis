...
class TeamAssigner:
    ...
    def load_model(self):
        self.model = CLIPModel.from_pretrained("krishnakamath/clip-vit-base-patch32-coco-finetuned-v2")
        self.processor = CLIPProcessor.from_pretrained("krishnakamath/clip-vit-base-patch32-coco-finetuned-v2")
